...
class AccesoriesInfoBuilder extends GetView<RequestController> {
  AccesoriesInfoBuilder({super.key, this.data});
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            12.ph,
            Text(
              data == null ? 'Add New Accessory' : 'Edit Accessory',
            ...
            SizedBox(
              ...
              child: PrimaryButton(
                ...
                onPressed: () => controller.saveAccesory(data: data),
              ),
            ),
            18.ph,
          ],
